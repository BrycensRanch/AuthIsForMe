			...
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
				...
				<div className="mx-auto max-w-7xl px-4">
					<p className="text-center text-gray-400">
						&copy; {new Date().getFullYear()} BrycensRanch. This site is not affiliated or sponsored by Mojang,
						Microsoft, or any of their partners. <a href="#">API documentation</a>
					</p>
				</div>
			</div>
		</Disclosure>
