		...
		>
			<section className="h-screen bg-white dark:bg-gray-900">
				<div className="mx-auto max-w-screen-xl px-4 py-8 text-center lg:py-16">
					...
					>
						Unify your Minecraft account to every platform.
					</h1>
				...
				<main className="mx-auto max-w-7xl px-4 py-6 ">
					<div className="mb-10">
						...
						<p className="mt-4 text-xl text-gray-600 dark:text-gray-400">
							AuthIsForMe makes it easy to link your Minecraft account to all of your favorite services, so you can
					...
					<div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3">
						<div className="rounded-lg bg-white px-6 py-8 shadow-lg">
							...
							<p className="text-lg text-gray-600">
								We take all the hassle out of integrating with multiple services and make it easy for you to get
								started.
							</p>
						</div>
					...
					<p>
						...
						together more effectively and grant server owners and web developers peace that they deserve for what
					...
					<p>
						Usually, the APIs I make are for my own use, but I thought that this one would be useful for the community
						as a whole. As such, I've gone out of my way to accept multiple data formats in and out of the API. I've
						also worked hard to try and follow the best practices for API design and HTTP semantics.
					</p>
				</main>
			</section>
		</Main>
