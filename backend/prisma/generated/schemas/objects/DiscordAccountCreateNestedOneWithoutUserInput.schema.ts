...
const Schema: z.ZodType<Prisma.DiscordAccountCreateNestedOneWithoutUserInput> = z
	.object({
		create: z
			.union([
...
export const DiscordAccountCreateNestedOneWithoutUserInputObjectSchema = Schema;
