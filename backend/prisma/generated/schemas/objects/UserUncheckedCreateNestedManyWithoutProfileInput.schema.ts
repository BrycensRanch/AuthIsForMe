...
const Schema: z.ZodType<Prisma.UserUncheckedCreateNestedManyWithoutProfileInput> = z
	.object({
		create: z
			.union([
...
export const UserUncheckedCreateNestedManyWithoutProfileInputObjectSchema = Schema;
