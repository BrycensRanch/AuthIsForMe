...
const Schema: z.ZodType<Prisma.ApiKeyUncheckedUpdateManyWithoutApiKeysInput> = z
	.object({
...
export const ApiKeyUncheckedUpdateManyWithoutApiKeysInputObjectSchema = Schema;
