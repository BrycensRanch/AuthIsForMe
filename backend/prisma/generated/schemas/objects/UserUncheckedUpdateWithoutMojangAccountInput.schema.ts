...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutMojangAccountInput> = z
	.object({
...
export const UserUncheckedUpdateWithoutMojangAccountInputObjectSchema = Schema;
