...
const Schema: z.ZodType<Prisma.TwitchAccountCreateNestedOneWithoutUserInput> = z
	.object({
		create: z
			.union([
...
export const TwitchAccountCreateNestedOneWithoutUserInputObjectSchema = Schema;
