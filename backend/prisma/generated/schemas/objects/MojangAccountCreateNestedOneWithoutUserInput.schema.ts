...
const Schema: z.ZodType<Prisma.MojangAccountCreateNestedOneWithoutUserInput> = z
	.object({
		create: z
			.union([
...
export const MojangAccountCreateNestedOneWithoutUserInputObjectSchema = Schema;
