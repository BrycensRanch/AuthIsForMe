...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutProfileNestedInput> = z
	.object({
		create: z
			.union([
...
export const UserUncheckedUpdateManyWithoutProfileNestedInputObjectSchema = Schema;
