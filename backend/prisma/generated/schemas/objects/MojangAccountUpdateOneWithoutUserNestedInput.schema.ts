...
const Schema: z.ZodType<Prisma.MojangAccountUpdateOneWithoutUserNestedInput> = z
	.object({
		create: z
			.union([
...
export const MojangAccountUpdateOneWithoutUserNestedInputObjectSchema = Schema;
