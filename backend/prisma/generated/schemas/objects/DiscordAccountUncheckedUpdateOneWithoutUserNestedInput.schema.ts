...
const Schema: z.ZodType<Prisma.DiscordAccountUncheckedUpdateOneWithoutUserNestedInput> = z
	.object({
		create: z
			.union([
...
export const DiscordAccountUncheckedUpdateOneWithoutUserNestedInputObjectSchema = Schema;
