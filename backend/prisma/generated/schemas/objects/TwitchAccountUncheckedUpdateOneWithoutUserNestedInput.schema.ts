...
const Schema: z.ZodType<Prisma.TwitchAccountUncheckedUpdateOneWithoutUserNestedInput> = z
	.object({
		create: z
			.union([
...
export const TwitchAccountUncheckedUpdateOneWithoutUserNestedInputObjectSchema = Schema;
