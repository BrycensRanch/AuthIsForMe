...
const Schema: z.ZodType<Prisma.FollowingUncheckedCreateNestedManyWithoutUserInput> = z
	.object({
		create: z
			.union([
...
export const FollowingUncheckedCreateNestedManyWithoutUserInputObjectSchema = Schema;
