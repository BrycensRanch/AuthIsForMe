...
const Schema: z.ZodType<Prisma.ApiKeyUncheckedCreateNestedManyWithoutOwnerInput> = z
	.object({
		create: z
			.union([
...
export const ApiKeyUncheckedCreateNestedManyWithoutOwnerInputObjectSchema = Schema;
